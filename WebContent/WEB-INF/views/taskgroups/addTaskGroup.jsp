...
<form:form method="post" cssClass="form-horizontal" modelAttribute="taskGroup">
	<fieldset>
		<legend>Add Task Group</legend>
		...
		<div class="form-actions">
			...
			<a class="btn" href="list?projectId=${taskGroup.project.id}">Cancel</a>
		</div>
	</fieldset>
</form:form>